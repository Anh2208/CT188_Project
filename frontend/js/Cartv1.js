...
let products = [
...

  {
    ...
    image:
      "../../assets/images/thung-30-goi-mi-hao-hao-tom-chua-cay-75g-202211181144401243.jpg",
    price: 120000,
    type: "collapse31",
  },
  {
...
function initApp() {
  products.forEach((value, key) => {
    ...
    newDiv.innerHTML = `
            ...
            <button onclick="addToCard(${key})">Thêm vào giỏ</button>`;
...
function searchProduct() {
  ...
  let filteredProducts = products.filter((product) => {
    // Chuyển tên sản phẩm và tên tìm kiếm về chữ thường và so sánh
